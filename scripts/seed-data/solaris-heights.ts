  ...
  standardSeats: [
    {
      ...
      propertyId: 'prop-a-101',
      isPrimaryOwner: true,
      platformAddress: 'thandi.a101@solarisheights.org',
    },
    {
      id: 'seat-lerato',
      userId: 'user-lerato-khumalo',
      propertyId: 'prop-a-201',
      isPrimaryOwner: true,
      platformAddress: 'lerato.a201@solarisheights.org',
    },
    {
      id: 'seat-amir',
      userId: 'user-amir-hassan',
      propertyId: 'prop-a-301',
      isPrimaryOwner: true,
      platformAddress: 'amir.a301@solarisheights.org',
    },
    {
      id: 'seat-zanele',
      userId: 'user-zanele-dlamini',
      ...
      platformAddress: 'zanele.a401@solarisheights.org',
    },
    {
      id: 'seat-pieter',
      userId: 'user-pieter-steyn',
      propertyId: 'prop-b-101',
      isPrimaryOwner: true,
      platformAddress: 'pieter.b101@solarisheights.org',
    },
    {
      id: 'seat-fatima',
      userId: 'user-fatima-adams',
      propertyId: 'prop-b-201',
      isPrimaryOwner: true,
      platformAddress: 'fatima.b201@solarisheights.org',
    },
    {
      id: 'seat-gregory',
      userId: 'user-gregory-naidoo',
      propertyId: 'prop-b-301',
      isPrimaryOwner: false,
      platformAddress: 'gregory.b301@solarisheights.org',
    },
    {
      id: 'seat-naledi',
      userId: 'user-naledi-zulu',
      propertyId: 'prop-b-401',
      isPrimaryOwner: true,
      platformAddress: 'naledi.b401@solarisheights.org',
    },
    {
      id: 'seat-rashid',
      userId: 'user-rashid-patel',
      propertyId: 'prop-c-101',
      isPrimaryOwner: true,
      platformAddress: 'rashid.c101@solarisheights.org',
    },
    {
      id: 'seat-tarryn',
      userId: 'user-tarryn-lewis',
      propertyId: 'prop-c-201',
      isPrimaryOwner: true,
      platformAddress: 'tarryn.c201@solarisheights.org',
    },
    {
      id: 'seat-sipho',
      userId: 'user-sipho-mthembu',
      propertyId: 'prop-c-301',
      isPrimaryOwner: true,
      platformAddress: 'sipho.c301@solarisheights.org',
    },
  ],
