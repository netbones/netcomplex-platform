...
const serviceDetails = {
  maintenance: {
    ...
    color: 'blue',
    description:
      'Professional maintenance and repair services to keep your home and community in perfect condition.',
    features: [
  ...
  security: {
    ...
    color: 'orange',
    description:
      'Comprehensive security solutions to ensure the safety and peace of mind for all residents.',
    features: [
  ...
  landscaping: {
    ...
    color: 'green',
    description:
      'Professional landscaping services to maintain beautiful outdoor spaces throughout our community.',
    features: [
  ...
  waste: {
    ...
    color: 'green',
    description:
      'Comprehensive waste management and recycling services to keep our community clean and sustainable.',
    features: [
  ...
  amenities: {
    ...
    color: 'cyan',
    description:
      'Access to our Share Codes with neighbouring amenities designed for recreation, fitness, and social activities.',
    features: [
      'Swimming Pool & Spa',
      'Fitness Center',
      'Community Center',
