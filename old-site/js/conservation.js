...
function handleConservationSignup(e) {
  ...
  const interests = Array.from(e.target.querySelectorAll('input[type="checkbox"]:checked')).map(
    cb => cb.value
  );

  // Simulate form submission
  alert(
    `Thank you for joining our conservation efforts!\n\nWe'll contact you soon with information about upcoming activities.\n\nSelected interests: ${interests.join(', ')}`
  );
