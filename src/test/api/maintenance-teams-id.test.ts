...
const mocks = vi.hoisted(() => ({
  ...
  apiGone: vi.fn((message = 'Resource has been deleted') =>
    new Response(
...
describe('PATCH /api/maintenance/teams/[id]', () => {
  ...
  it('returns 410 when team is soft-deleted', async () => {
    mocks.dbMock.select.mockReturnValue(makeSelectChain([deletedTeam]));
  ...
  it('updates team name successfully', async () => {
    ...
    const updated = { ...activeTeam, name: 'Updated Plumbers', updatedAt: new Date('2026-06-21T12:00:00Z') };
  ...
  it('updates team contactName successfully', async () => {
    ...
    const updated = { ...activeTeam, contactName: 'Bob', updatedAt: new Date('2026-06-21T12:00:00Z') };
    mocks.dbMock.update.mockReturnValue(makeUpdateChain([updated]));
...
describe('DELETE /api/maintenance/teams/[id]', () => {
  ...
  it('soft-deletes a team successfully', async () => {
    mocks.dbMock.select.mockReturnValue(makeSelectChain([activeTeam]));
    mocks.dbMock.update.mockReturnValue(makeUpdateChain([{ ...activeTeam, deletedAt: new Date('2026-06-21T12:00:00Z') }]));
