...
vi.mock('@api/server', async () => {
  ...
  return {
    db: mocks.dbMock,
    serviceProviders: {
      id: 'id', tenantId: 'tenantId', companyName: 'companyName',
      contactName: 'contactName', phone: 'phone', email: 'email',
      trade: 'trade', isActive: 'isActive',
...
describe('GET /api/maintenance/providers', () => {
  ...
  it('returns list of providers when authorized', async () => {
    const providers = [
      { id: 'p-1', tenantId: 'test-tenant-id', companyName: 'ABC Plumbing', trade: 'PLUMBING', contactName: 'Alice', phone: '555-0100', email: 'alice@abc.com', isActive: true, createdAt: new Date(), updatedAt: new Date(), deletedAt: null },
      { id: 'p-2', tenantId: 'test-tenant-id', companyName: 'XYZ Electric', trade: 'ELECTRICAL', contactName: 'Bob', phone: '555-0200', email: 'bob@xyz.com', isActive: true, createdAt: new Date(), updatedAt: new Date(), deletedAt: null },
    ];
