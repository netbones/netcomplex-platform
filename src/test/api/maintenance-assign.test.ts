...
vi.mock('@api/server', async () => {
  ...
  return {
    ...
    db: mocks.dbMock,
    maintenanceRequests: {
      id: 'id', tenantId: 'tenantId', userId: 'userId', category: 'category',
      priority: 'priority', description: 'description', status: 'status',
      assignedTeamId: 'assignedTeamId', assignedProviderId: 'assignedProviderId',
      createdAt: 'createdAt', updatedAt: 'updatedAt',
    },
    maintenanceTeams: { id: 'id', tenantId: 'tenantId', name: 'name', trade: 'trade', isActive: 'isActive' },
    serviceProviders: { id: 'id', tenantId: 'tenantId', companyName: 'companyName', trade: 'trade', isActive: 'isActive' },
    requestHistories: {
...
describe('POST /api/maintenance/[id]/assign', () => {
  ...
  it('assigns a provider successfully with auto-transition', async () => {
    ...
    mocks.dbMock.select
      ...
      .mockReturnValueOnce(makeSelectChain([{ id: PROVIDER_ID, companyName: 'FixIt Co', trade: 'PLUMBING' }]));
    ...
    expect(body.data.assignedProvider).toEqual({ id: PROVIDER_ID, companyName: 'FixIt Co', trade: 'PLUMBING' });
    expect(mocks.revalidateDashboard).toHaveBeenCalled();
  });
