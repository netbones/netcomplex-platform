...
export const ADMIN_DOMAIN_DEFINITIONS: AdminDomainDef[] = [
  ...
  },
  {
    ...
    descriptionKey: 'domains.descriptions.adminAmenities',
    icon: '/platform/amenities.svg',
    description: 'Create, reorder, and manage community amenities',
    category: 'operations',
  },
  {
    id: 'security',
    labelKey: 'domains.security',
    descriptionKey: 'domains.descriptions.adminSecurity',
    icon: '/platform/merits.svg',
    description: 'Panic alerts, security contacts, and anonymous tips',
    category: 'operations',
  },
  {
    id: 'access-control',
  ...
  {
    id: 'carousel',
    labelKey: 'domains.carousel',
    descriptionKey: 'domains.descriptions.carousel',
    icon: '/platform/carousel.svg',
