...
import { Wrench, Calendar, ChevronRight, ClipboardPlus, CalendarPlus } from 'lucide-react';
...
const RESIDENT_SHORTCUTS: ShortcutDef[] = [
  {
    id: 'new-request',
    label: 'New Request',
    icon: ClipboardPlus,
...
export function ServicesCommandBar({ urgency }: ServicesCommandBarProps) {
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {RESIDENT_SHORTCUTS.map(shortcut => (
