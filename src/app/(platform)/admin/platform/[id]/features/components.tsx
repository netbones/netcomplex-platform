...
function FeaturesForm({ tenant, allFeatures }: TenantFeaturesFormProps) {
  ...
  const tierOrder = ['foundation', 'depth', 'core'];
  const currentTierIndex = tierOrder.indexOf(tenant.subscriptionTier || 'foundation');
