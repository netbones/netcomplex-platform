...
export default function AboutPage() {
  const { tx } = useSafeTranslation('platform');
      ...
      <main>
        ...
        <section className="bg-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-lapis-deep text-center mb-12">
              {tx('about.valuesTitle', 'What We Believe')}
            </h2>
              ...
              {values.map(value => (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-lapis-deep mb-3">
                    {tx(value.titleKey, value.defaultTitle)}
                  </h3>
                  <p className="text-lapis-mid">{tx(value.descKey, value.defaultDesc)}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                {tx('about.builtByLink', 'Visit netbones.co.za')}
        ...
        <section className="bg-lapis-deep text-white py-20">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            >
              {tx('cta.primaryAction', 'Start Free Trial')}
            </a>
          </div>
        </section>
      </main>
