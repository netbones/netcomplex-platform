...
describe('GET /api/community-services/listings', () => {
  ...
  it('returns paginated list of published listings', async () => {
    ...
    const reviewCountsChain = makeSelectChain([
      { listingId: 'listing-1', count: 3 },
      { listingId: 'listing-2', count: 1 },
    ]);
    let callIdx = 0;
  ...
  it('filters by category query param', async () => {
    ...
    const response = await GET(
      req('http://localhost:3000/api/community-services/listings?category=GARDENING')
    );
    expect(response.status).toBe(200);
  });
  ...
  it('filters by category=ALL (no category filter)', async () => {
    ...
    const response = await GET(
      req('http://localhost:3000/api/community-services/listings?category=ALL')
    );
    expect(response.status).toBe(200);
  });
  ...
  it('filters by search text', async () => {
    ...
    const response = await GET(
      req('http://localhost:3000/api/community-services/listings?search=lawn')
    );
    expect(response.status).toBe(200);
  });
  ...
  it('filters by verified=true', async () => {
    ...
    const response = await GET(
      req('http://localhost:3000/api/community-services/listings?verified=true')
    );
    expect(response.status).toBe(200);
  });
  ...
  it('filters by featured=true', async () => {
    ...
    const response = await GET(
      req('http://localhost:3000/api/community-services/listings?featured=true')
    );
    expect(response.status).toBe(200);
  });
  ...
  it('filters by providerId', async () => {
    ...
    const response = await GET(
      req('http://localhost:3000/api/community-services/listings?providerId=provider-1')
    );
    expect(response.status).toBe(200);
  });
  ...
  it('supports pagination with limit and offset', async () => {
    ...
    const response = await GET(
      req('http://localhost:3000/api/community-services/listings?limit=5&offset=10')
    );
    expect(response.status).toBe(200);
    const body = await response.json();
  ...
  it('returns single listing by id query param', async () => {
    ...
    const response = await GET(
      req('http://localhost:3000/api/community-services/listings?id=listing-1')
    );
    expect(response.status).toBe(200);
    const body = await response.json();
  ...
  it('returns 404 when single listing by id is not found', async () => {
    ...
    const response = await GET(
      req('http://localhost:3000/api/community-services/listings?id=nonexistent')
    );
...
describe('POST /api/community-services/listings', () => {
  it('returns 403 when community_services module is disabled', async () => {
    ...
    const response = await POST(
      req('http://localhost:3000/api/community-services/listings', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
