...
export default function AccessControlLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!isFeatureEnabled(tenant, 'page.accessControl')) {
    return (
      <div className="min-h-[400px] flex items-center justify-center">
        <div className="bg-white rounded-lg shadow p-8 text-center max-w-md">
          <Ban className="w-12 h-12 text-gray-300 mx-auto mb-4" />
          <h2 className="text-lg font-semibold text-gray-900 mb-2">Access Control Unavailable</h2>
          <p className="text-gray-500">Visitor access control is not enabled for your community.</p>
          <Link
            href="/"
