      ...
      <div className="flex items-center justify-center gap-8 py-6">
        ...
        >
          <defs>
            ...
            >
              <circle cx="2" cy="2" r="1.2" fill="#d0d7de" />
            </pattern>
            <filter id="dwSoftShadow" x="-10%" y="-10%" width="120%" height="120%">
              <feDropShadow
                dx="0"
                dy="8"
                stdDeviation="6"
            ...
            <style>
              {
                '.dw-bg-dots{fill:url(#dwDotPattern)}.dw-pg{fill:#76d795}.dw-ds{fill:#2c3e50}.dw-ms{fill:#4a5d6e}.dw-lg{fill:#f1f4f6}.dw-sk{fill:#f0a08e}.dw-wh{fill:#fff}.dw-gd{fill:#fcd34d}.dw-sd{stroke:#2c3e50;stroke-width:2.5;stroke-linecap:round;stroke-linejoin:round}.dw-sg{stroke:#76d795;stroke-width:2.5;stroke-linecap:round}'
              }
            </style>
          </defs>
          <g>
            <polygon points="120,100 680,80 720,420 80,440" className="dw-bg-dots" opacity="0.7" />
            <g transform="translate(140, 160)" className="dw-lg" opacity="0.8">
              <path d="M20,0 L24,6 L31,3 L33,10 L40,11 L39,18 L45,22 L41,28 L45,34 L39,37 L39,44 L32,44 L29,51 L22,48 L17,53 L13,47 L6,47 L6,40 L0,36 L3,30 L0,23 L6,20 L5,13 L12,11 L13,4 L20,6 Z" />
              <circle cx="22" cy="26" r="10" fill="#ffffff" />
            </g>
            <g transform="translate(640, 220) scale(0.7)" fill="#d0d7de" opacity="0.6">
              <circle cx="20" cy="20" r="25" />
            </g>
            <g transform="translate(180, 260)">
              <path d="M0,-15 L4,-4 L15,0 L4,4 L0,15 L-4,4 L-15,0 L-4,-4 Z" className="dw-pg" />
            </g>
            <g transform="translate(620, 140)">
              <path d="M0,-20 L5,-5 L20,0 L5,5 L0,20 L-5,5 L-20,0 L-5,-5 Z" className="dw-pg" />
            </g>
            <circle cx="260" cy="180" r="12" fill="#76d795" opacity="0.3" />
            <circle cx="580" cy="320" r="8" fill="#76d795" opacity="0.4" />
          </g>
          <g transform="translate(0, 20)">
            <g filter="url(#dwSoftShadow)">
              <rect x="260" y="160" width="280" height="380" rx="24" className="dw-wh" />
              <rect
                x="260"
                y="160"
                width="280"
                ...
                className="dw-sd"
              />
              <rect x="275" y="180" width="250" height="200" rx="12" className="dw-lg" />
              <rect x="295" y="200" width="210" height="120" rx="12" className="dw-ds" />
              <rect x="315" y="280" width="60" height="12" rx="4" className="dw-pg" />
              <circle cx="470" cy="230" r="16" fill="#ffffff" opacity="0.2" />
              <circle cx="485" cy="230" r="16" fill="#76d795" opacity="0.4" />
              <text
                x="315"
                y="240"
              ...
              <rect x="295" y="340" width="100" height="12" rx="6" className="dw-ms" />
              <rect x="295" y="362" width="150" height="8" rx="4" fill="#d0d7de" />
              <rect x="295" y="378" width="120" height="8" rx="4" fill="#d0d7de" />
              <rect x="295" y="410" width="210" height="50" rx="10" className="dw-pg" />
              <text
                x="345"
                y="440"
                fontFamily="sans-serif"
              ...
              <circle cx="320" cy="435" r="12" className="dw-wh" />
              <path d="M314,435 L318,439 L326,430" fill="none" className="dw-sg" />
            </g>
            <g>
              <path d="M 80,380 L 210,350 L 210,410 L 80,450 Z" className="dw-ds" />
              <path d="M 80,380 L 210,350 L 210,410 L 80,450 Z" fill="none" className="dw-sd" />
              <polygon points="210,350 222,347 222,407 210,410" className="dw-wh" />
              <polygon points="210,350 222,347 222,407 210,410" fill="none" className="dw-sd" />
              <path
                d="M 222,360 C 240,360 250,370 265,375 C 260,385 250,390 235,390 L 222,390 Z"
                className="dw-sk"
              />
              <path d="M 222,360 C 240,360 250,370 265,375" fill="none" className="dw-sd" />
            </g>
            <g transform="translate(210, 260)" filter="url(#dwSoftShadow)">
              <rect x="0" y="20" width="70" height="60" rx="6" className="dw-pg" />
              <rect x="0" y="20" width="70" height="60" rx="6" fill="none" className="dw-sd" />
              <rect x="-5" y="10" width="80" height="15" rx="4" className="dw-wh" />
              <rect x="-5" y="10" width="80" height="15" rx="4" fill="none" className="dw-sd" />
              <rect x="28" y="20" width="14" height="60" className="dw-ds" />
              <rect x="28" y="10" width="14" height="15" className="dw-ds" />
              <path
                d="M 20,2 C 10,-10 35,-10 35,10 C 35,-10 60,-10 50,2 C 40,10 35,10 35,10 Z"
                className="dw-ds"
              />
              <path
                d="M 20,2 C 10,-10 35,-10 35,10 C 35,-10 60,-10 50,2 C 40,10 35,10 35,10 Z"
            ...
            <g>
              <path d="M 720,380 L 580,340 L 570,400 L 720,460 Z" className="dw-pg" />
              <path d="M 720,380 L 580,340 L 570,400 L 720,460 Z" fill="none" className="dw-sd" />
              <path
                d="M 620,360 L 625,370 M 660,375 L 665,385 M 600,380 L 605,390"
                className="dw-sd"
                strokeWidth="2"
              />
              <path
                d="M 580,340 C 550,335 520,350 495,360 C 490,368 500,378 515,375 C 530,372 550,370 570,380 Z"
                className="dw-sk"
              />
              <path
                d="M 580,340 C 550,335 520,350 495,360 C 490,368 500,378 515,375 C 530,372 550,370 570,380"
                fill="none"
                className="dw-sd"
              />
              <path
                d="M 520,362 C 505,365 490,372 498,380 C 510,380 525,372 535,370"
                className="dw-sk"
              />
              <path d="M 520,362 C 505,365 490,372 498,380" fill="none" className="dw-sd" />
            </g>
            <g>
              <g transform="translate(350, 110)" filter="url(#dwSoftShadow)">
                <circle cx="0" cy="0" r="28" className="dw-gd" />
                <circle cx="0" cy="0" r="28" fill="none" className="dw-sd" />
                <circle cx="0" cy="0" r="21" fill="none" className="dw-sd" strokeDasharray="4 3" />
                <polygon
                  points="0,-10 3,-3 10,-2 5,3 7,10 0,6 -7,10 -5,3 -10,-2 -3,-3"
                  className="dw-ds"
                />
              </g>
              <g transform="translate(490, 130)" filter="url(#dwSoftShadow)">
                <circle cx="0" cy="0" r="22" className="dw-gd" />
                <circle cx="0" cy="0" r="22" fill="none" className="dw-sd" />
                <text
                  x="-6"
                  y="7"
                  fontFamily="sans-serif"
              ...
              <g transform="translate(260, 130)">
                <circle cx="0" cy="0" r="15" className="dw-gd" />
                <circle cx="0" cy="0" r="15" fill="none" className="dw-sd" />
                <text
                  x="-4"
                  y="5"
                  fontFamily="sans-serif"
              ...
              <polygon
                points="430,70 434,80 445,81 437,88 439,98 430,93 421,98 423,88 415,81 426,80"
                className="dw-pg"
                stroke="#2c3e50"
                strokeWidth="1.5"
              />
              <polygon
                points="230,210 233,217 240,218 235,223 236,230 230,226 224,230 225,223 220,218 227,217"
                className="dw-gd"
                stroke="#2c3e50"
                strokeWidth="1.5"
              />
              <path d="M 350,70 L 350,55" className="dw-sd" strokeWidth="2" />
              <path d="M 380,75 L 390,65" className="dw-sd" strokeWidth="2" />
              <path d="M 320,75 L 310,65" className="dw-sd" strokeWidth="2" />
            </g>
            <line x1="60" y1="520" x2="740" y2="520" className="dw-sd" strokeWidth="3" />
          </g>
        </svg>
      </div>
