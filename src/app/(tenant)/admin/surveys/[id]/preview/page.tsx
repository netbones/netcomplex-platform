...
import type {
  ...
  SurveySection,
  QuestionType,
} from '@/components/surveys/builder/survey-types';
import { getTypeMeta } from '@/components/surveys/builder/survey-types';
import { SingleChoiceBlock } from '@/components/surveys/builder/question-types/SingleChoiceBlock';
import { MultipleChoiceBlock } from '@/components/surveys/builder/question-types/MultipleChoiceBlock';
import { TextBlock } from '@/components/surveys/builder/question-types/TextBlock';
import { RatingBlock } from '@/components/surveys/builder/question-types/RatingBlock';
import { YesNoBlock } from '@/components/surveys/builder/question-types/YesNoBlock';
import { LinearScaleBlock } from '@/components/surveys/builder/question-types/LinearScaleBlock';
...
interface PreviewSurveyPageProps {
  params: Promise<{ id: string }>;
}

export default function PreviewSurveyPage({ params }: PreviewSurveyPageProps) {
  ...
  const loadSurvey = useCallback(async () => {
    ...
    try {
      ...
      logError(
        { component: 'PreviewSurveyPage', operation: 'loadSurvey' },
