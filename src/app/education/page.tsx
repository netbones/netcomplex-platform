      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-3 mt-6 mb-6">
          <div className="w-10 h-10 rounded-lg bg-indigo-100 flex items-center justify-center">
            <i className="ti ti-books text-indigo-600 text-xl" />
          </div>
          <div>
        ...
        <style>{`
          ...
          .edu-tab i { margin-right: 6px; font-size: 15px; vertical-align: -2px; }
          ...
          .edu-card { background: var(--surface-2); border: 0.5px solid var(--border); border-radius: 12px; padding: 1rem 1.125rem; display: flex; flex-direction: column; gap: 0.5rem; }
          ...
          .edu-pill { font-size: 11px; padding: 2px 8px; border-radius: 99px; border: 0.5px solid var(--border); color: var(--text-secondary); background: var(--surface-1); }
          ...
          .edu-btn-small { font-size: 12px; padding: 4px 12px; cursor: pointer; display: inline-flex; align-items: center; gap: 4px; border: 0.5px solid var(--border); border-radius: var(--radius); background: var(--surface-1); color: var(--text-primary); text-decoration: none; }
          .edu-btn-small:hover { background: var(--surface-2); }
          ...
          .edu-featured { background: var(--surface-1); border: 0.5px solid var(--border); border-radius: 12px; padding: 1rem 1.25rem; margin-bottom: 1.25rem; display: flex; align-items: center; gap: 1rem; }
          ...
          .edu-stat { background: var(--surface-1); border-radius: var(--radius); padding: 0.75rem 1rem; }
          ...
          .edu-spine { min-width: 100px; max-width: 120px; border-radius: 6px; padding: 0.75rem 0.6rem; cursor: pointer; border: 0.5px solid var(--border); background: var(--surface-2); display: flex; flex-direction: column; justify-content: flex-end; gap: 4px; flex-shrink: 0; text-decoration: none; color: inherit; }
          .edu-spine:hover { border-color: var(--border-strong); background: var(--surface-1); }
