...
export const propertiesTopremiumSeatsRelations = relations(propertiesTopremiumSeats, helpers => ({
  property: helpers.one(properties, {
    fields: [propertiesTopremiumSeats.A],
    references: [properties.id],
  }),
  premiumSeat: helpers.one(premiumSeats, {
    fields: [propertiesTopremiumSeats.B],
