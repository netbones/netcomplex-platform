...
export const communityServiceInquiriesRelations = relations(communityServiceInquiries, (helpers) => ({ Tenant: helpers.one(tenants, { relationName: 'CommunityServiceInquiryToTenant', fields: [ communityServiceInquiries.tenantId ], references: [ tenants.id ] }), user: helpers.one(users, { relationName: 'CommunityServiceInquiryTouser', fields: [ communityServiceInquiries.inquirerId ], references: [ users.id ] }), communityServiceListing: helpers.one(communityServiceListings, { relationName: 'CommunityServiceInquiryToCommunityServiceListing', fields: [ communityServiceInquiries.listingId ], references: [ communityServiceListings.id ] }) }));