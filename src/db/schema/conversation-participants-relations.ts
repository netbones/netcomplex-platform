...
export const conversationParticipantsRelations = relations(conversationParticipants, (helpers) => ({ Conversation: helpers.one(conversations, { relationName: 'ConversationToConversationParticipant', fields: [ conversationParticipants.conversationId ], references: [ conversations.id ] }), Tenant: helpers.one(tenants, { relationName: 'ConversationParticipantToTenant', fields: [ conversationParticipants.tenantId ], references: [ tenants.id ] }), user: helpers.one(users, { relationName: 'ConversationParticipantTouser', fields: [ conversationParticipants.userId ], references: [ users.id ] }) }));