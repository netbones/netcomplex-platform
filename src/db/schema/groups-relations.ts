...
export const groupsRelations = relations(groups, helpers => ({
  Content: helpers.many(contents, { relationName: 'ContentToGroup' }),
  ...
  Tenant: helpers.one(tenants, {
    relationName: 'GroupToTenant',
    fields: [groups.tenantId],
    references: [tenants.id],
  }),
  GroupMember: helpers.many(groupMembers, { relationName: 'GroupToGroupMember' }),
