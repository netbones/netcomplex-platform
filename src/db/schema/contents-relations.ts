...
export const contentsRelations = relations(contents, helpers => ({
  ...
  versions: helpers.many(contentVersions, { relationName: 'ContentToContentVersion' }),
  auditLogs: helpers.many(contentAuditLogs, { relationName: 'ContentToContentAuditLog' }),
  comments: helpers.many(comments, { relationName: 'CommentToContent' }),
}));
