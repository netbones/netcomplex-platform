...
export const providerLegalAgreementsRelations = relations(providerLegalAgreements, helpers => ({
  Tenant: helpers.one(tenants, {
    relationName: 'ProviderLegalAgreementToTenant',
    fields: [providerLegalAgreements.tenantId],
    references: [tenants.id],
  }),
  provider: helpers.one(serviceProviders, {
    relationName: 'ProviderLegalAgreementToServiceProvider',
    fields: [providerLegalAgreements.providerId],
