...
import * as agentReviews from './agent-reviews';
...
import * as seatSubscriptions from './seat-subscriptions';
...
import * as providerDueDiligenceWorkflows from './provider-due-diligence-workflows';
import * as providerDueDiligenceItems from './provider-due-diligence-items';
import * as providerDueDiligenceDocuments from './provider-due-diligence-documents';
import * as providerDueDiligenceEvents from './provider-due-diligence-events';
...
import * as agentReviewsRelations from './agent-reviews-relations';
...
import * as seatSubscriptionsRelations from './seat-subscriptions-relations';
...
import * as providerDueDiligenceWorkflowsRelations from './provider-due-diligence-workflows-relations';
import * as providerDueDiligenceItemsRelations from './provider-due-diligence-items-relations';
import * as providerDueDiligenceDocumentsRelations from './provider-due-diligence-documents-relations';
import * as providerDueDiligenceEventsRelations from './provider-due-diligence-events-relations';
...
import * as securityAlertsRelations from './security-alerts-relations';
import * as securityContactsRelations from './security-contacts-relations';
...
export const schema = {
  ...
  ...agentReviewsRelations,
  ...premiumSeatsRelations,
  ...soloSeatsRelations,
  ...standardSeatsRelations,
  ...seatPlansRelations,
  ...seatSubscriptionsRelations,
  ...userKeysRelations,
  ...
  ...providerDueDiligenceWorkflowsRelations,
  ...providerDueDiligenceItemsRelations,
  ...providerDueDiligenceDocumentsRelations,
  ...providerDueDiligenceEventsRelations,
  ...
  ...securityAlertsRelations,
  ...securityContactsRelations,
  ...tenantsRelations,
