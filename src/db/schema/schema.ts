...
export const schema = { ...platformModules, ...tenantModules, ...assistSessions, ...tenants, ...announcements, ...bookings, ...contents, ...conversations, ...conversationParticipants, ...competitions, ...competitionEntries, ...events, ...eventAttendees, ...externalSurveys, ...groups, ...groupMembershipRequests, ...maintenanceRequests, ...maintenanceTeams, ...serviceProviders, ...maintenanceCategories, ...requestNotes, ...requestHistories, ...messages, ...notifications, ...questions, ...responses, ...settings, ...surveySections, ...surveys, ...groupMembers, ...accounts, ...agentAccesses, ...agentProfiles, ...albums, ...communityServiceInquiries, ...communityServiceListings, ...communityServiceReviews, ...properties, ...households, ...invitations, ...members, ...organizations, ...passkeys, ...platformSuspensions, ...premiumSeats, ...profiles, ...propertyListings, ...sessions, ...soloSeats, ...standardSeats, ...twoFactors, ...users, ...verifications, ...resources, ...resourceVersions, ...platformModulesRelations, ...tenantModulesRelations, ...assistSessionsRelations, ...tenantsRelations, ...announcementsRelations, ...bookingsRelations, ...contentsRelations, ...conversationsRelations, ...conversationParticipantsRelations, ...competitionsRelations, ...competitionEntriesRelations, ...eventsRelations, ...eventAttendeesRelations, ...groupsRelations, ...groupMembershipRequestsRelations, ...maintenanceRequestsRelations, ...maintenanceTeamsRelations, ...serviceProvidersRelations, ...requestNotesRelations, ...requestHistoriesRelations, ...messagesRelations, ...notificationsRelations, ...questionsRelations, ...responsesRelations, ...surveySectionsRelations, ...surveysRelations, ...groupMembersRelations, ...accountsRelations, ...agentAccessesRelations, ...agentProfilesRelations, ...albumsRelations, ...communityServiceInquiriesRelations, ...communityServiceListingsRelations, ...communityServiceReviewsRelations, ...propertiesRelations, ...householdsRelations, ...invitationsRelations, ...membersRelations, ...organizationsRelations, ...passkeysRelations, ...platformSuspensionsRelations, ...premiumSeatsRelations, ...profilesRelations, ...propertyListingsRelations, ...sessionsRelations, ...soloSeatsRelations, ...standardSeatsRelations, ...twoFactorsRelations, ...usersRelations, ...resourcesRelations, ...resourceVersionsRelations, ...propertiesTopremiumSeats, ...propertiesTopremiumSeatsRelations };