...
export const schema = { ...accounts, ...verifications, ...passkeys, ...sessions, ...twoFactors, ...users, ...profiles, ...members, ...organizations, ...notifications, ...serviceBookings, ...agentProfiles, ...premiumSeats, ...soloSeats, ...standardSeats, ...userKeys, ...userDevices, ...platformModules, ...tenantModules, ...settings, ...tenantSetups, ...setupMissions, ...setupSettings, ...properties, ...households, ...propertyListings, ...propertyPremiumSeats, ...invitations, ...conversations, ...conversationParticipants, ...messages, ...contents, ...contentLikes, ...contentVersions, ...contentAuditLogs, ...supports, ...groups, ...groupMembers, ...groupMembershipRequests, ...albums, ...resources, ...resourceVersions, ...announcements, ...events, ...eventAttendees, ...bookings, ...maintenanceRequests, ...maintenanceTeams, ...maintenanceTeamMembers, ...maintenanceCategories, ...bursaryFields, ...requestNotes, ...internalMaintenanceNotes, ...requestHistories, ...serviceProviders, ...communityServiceInquiries, ...communityServiceListings, ...communityServiceReviews, ...providerVerifications, ...providerLegalAgreements, ...providerReputations, ...providerMerits, ...providerSubscriptions, ...paymentTransactions, ...revenueRecords, ...providerCharges, ...providerInvoices, ...billingPlans, ...tenantSubscriptions, ...tenantInvoices, ...tenantPayments, ...billingAdjustments, ...billingEvents, ...coupons, ...couponRedemptions, ...taxRates, ...taxJurisdictions, ...surveys, ...questions, ...responses, ...surveySections, ...externalSurveys, ...communityMerits, ...competitions, ...competitionEntries, ...assistSessions, ...agentAccesses, ...agentTokens, ...delegationActions, ...residentDelegations, ...platformSuspensions, ...subscriptionTiers, ...achievementDefinitions, ...tenantAchievements, ...userAchievementProgresses, ...userAchievements, ...dWallets, ...walletTransactions, ...dataConsents, ...payoutRequests, ...dataRevenueStreams, ...dataShareBatches, ...addresses, ...handles, ...addressEndpoints, ...platformAiTierQuotas, ...aiCapabilityCosts, ...tenantAiUsages, ...aiUsageEvents, ...disputeCases, ...disputeEvidences, ...disputeEvents, ...disputeMessages, ...disputeMessageVersions, ...disputeNotifications, ...bursaries, ...outboxes, ...outboxDeadLetters, ...mediaUploads, ...meetingProxies, ...tenants, ...tenantFeatureFlags, ...accountsRelations, ...passkeysRelations, ...sessionsRelations, ...twoFactorsRelations, ...usersRelations, ...profilesRelations, ...membersRelations, ...organizationsRelations, ...notificationsRelations, ...serviceBookingsRelations, ...agentProfilesRelations, ...premiumSeatsRelations, ...soloSeatsRelations, ...standardSeatsRelations, ...userKeysRelations, ...userDevicesRelations, ...platformModulesRelations, ...tenantModulesRelations, ...settingsRelations, ...tenantSetupsRelations, ...setupMissionsRelations, ...setupSettingsRelations, ...propertiesRelations, ...householdsRelations, ...propertyListingsRelations, ...propertyPremiumSeatsRelations, ...invitationsRelations, ...conversationsRelations, ...conversationParticipantsRelations, ...messagesRelations, ...contentsRelations, ...contentLikesRelations, ...contentVersionsRelations, ...contentAuditLogsRelations, ...supportsRelations, ...groupsRelations, ...groupMembersRelations, ...groupMembershipRequestsRelations, ...albumsRelations, ...resourcesRelations, ...resourceVersionsRelations, ...announcementsRelations, ...eventsRelations, ...eventAttendeesRelations, ...bookingsRelations, ...maintenanceRequestsRelations, ...maintenanceTeamsRelations, ...maintenanceTeamMembersRelations, ...maintenanceCategoriesRelations, ...bursaryFieldsRelations, ...requestNotesRelations, ...internalMaintenanceNotesRelations, ...requestHistoriesRelations, ...serviceProvidersRelations, ...communityServiceInquiriesRelations, ...communityServiceListingsRelations, ...communityServiceReviewsRelations, ...providerVerificationsRelations, ...providerLegalAgreementsRelations, ...providerReputationsRelations, ...providerMeritsRelations, ...providerSubscriptionsRelations, ...paymentTransactionsRelations, ...revenueRecordsRelations, ...providerChargesRelations, ...providerInvoicesRelations, ...billingPlansRelations, ...tenantSubscriptionsRelations, ...tenantInvoicesRelations, ...tenantPaymentsRelations, ...billingAdjustmentsRelations, ...billingEventsRelations, ...couponsRelations, ...couponRedemptionsRelations, ...taxRatesRelations, ...taxJurisdictionsRelations, ...surveysRelations, ...questionsRelations, ...responsesRelations, ...surveySectionsRelations, ...externalSurveysRelations, ...communityMeritsRelations, ...competitionsRelations, ...competitionEntriesRelations, ...assistSessionsRelations, ...agentAccessesRelations, ...agentTokensRelations, ...delegationActionsRelations, ...residentDelegationsRelations, ...platformSuspensionsRelations, ...subscriptionTiersRelations, ...achievementDefinitionsRelations, ...tenantAchievementsRelations, ...userAchievementProgressesRelations, ...userAchievementsRelations, ...dWalletsRelations, ...walletTransactionsRelations, ...dataConsentsRelations, ...payoutRequestsRelations, ...dataRevenueStreamsRelations, ...dataShareBatchesRelations, ...addressesRelations, ...handlesRelations, ...addressEndpointsRelations, ...tenantAiUsagesRelations, ...aiUsageEventsRelations, ...disputeCasesRelations, ...disputeEvidencesRelations, ...disputeEventsRelations, ...disputeMessagesRelations, ...disputeMessageVersionsRelations, ...disputeNotificationsRelations, ...bursariesRelations, ...mediaUploadsRelations, ...meetingProxiesRelations, ...tenantsRelations, ...tenantFeatureFlagsRelations };