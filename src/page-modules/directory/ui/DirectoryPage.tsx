...
import { DirectoryGrid } from '@features/directory';
...
export function DirectoryPage() {
  ...
  const currentViewMode = activeTab === 'residents' ? viewMode : servicesViewMode;
    ...
    <ErrorBoundary>
      <main className="min-h-screen bg-soralia-light">
        <div className="container mx-auto px-4 py-8">
          ...
          {activeTab === 'residents' ? renderResidentsTab() : renderServicesTab()}
        </div>
      </main>
    </ErrorBoundary>
  );
