...
import type { FeatureKey, GateResult } from '@entities/tenant/api/gate/mappings';
import { FEATURE_TO_FLAG, FEATURE_TO_REGISTRY } from '@entities/tenant/api/gate/mappings';
