 ...
 *
 * Space-keyed defaults for the Focus Spaces architecture.
 * Each constant maps space IDs to widget lists/layout positions.
 *
 * DATA SHAPE:
 ...
 *
 * STORAGE:
 * - dashboardLayout on User model is `string | null` (JSON.stringify of { layouts, userWidgets })
...
const RESIDENT_LAYOUTS: WidgetLayouts = {
  ...
  services: {
    ...
    events: { x: 0, y: 3, width: 4, height: 2, isCollapsed: false },
    notifications: { x: 0, y: 5, width: 4, height: 2, isCollapsed: false },
    'my-services': { x: 0, y: 7, width: 2, height: 2, isCollapsed: false },
    'service-inquiries': { x: 2, y: 7, width: 2, height: 2, isCollapsed: false },
  },
  community: {
    ...
    'premium-portfolio': { x: 0, y: 4, width: 4, height: 3, isCollapsed: false },
    'agent-dashboard': { x: 0, y: 7, width: 2, height: 3, isCollapsed: false },
    'agent-activity': { x: 2, y: 7, width: 2, height: 3, isCollapsed: false },
    'community-graph-widget': { x: 0, y: 10, width: 4, height: 3, isCollapsed: false },
  },
  messages: {
    messages: { x: 0, y: 0, width: 4, height: 3, isCollapsed: false },
    notifications: { x: 0, y: 3, width: 4, height: 2, isCollapsed: false },
  },
};
...
const BOARD_LAYOUTS: WidgetLayouts = {
  ...
  services: {
    ...
    events: { x: 0, y: 3, width: 4, height: 2, isCollapsed: false },
    'my-services': { x: 0, y: 5, width: 2, height: 2, isCollapsed: false },
    'service-inquiries': { x: 2, y: 5, width: 2, height: 2, isCollapsed: false },
  },
  community: {
    ...
    'premium-portfolio': { x: 0, y: 5, width: 4, height: 3, isCollapsed: false },
    'agent-dashboard': { x: 0, y: 8, width: 4, height: 3, isCollapsed: false },
  },
  messages: {
    messages: { x: 0, y: 0, width: 4, height: 3, isCollapsed: false },
    notifications: { x: 0, y: 3, width: 4, height: 2, isCollapsed: false },
  ...
  admin: {
    ...
    'admin-quick-links': { x: 2, y: 2, width: 1, height: 2, isCollapsed: false },
...
const ADMIN_LAYOUTS: WidgetLayouts = {
  ...
  services: {
    ...
    events: { x: 0, y: 3, width: 4, height: 2, isCollapsed: false },
    'admin-resources': { x: 0, y: 5, width: 4, height: 3, isCollapsed: false },
  },
  community: {
    ...
    'admin-system': { x: 0, y: 4, width: 4, height: 3, isCollapsed: false },
    'page-settings': { x: 0, y: 7, width: 4, height: 3, isCollapsed: false },
  },
  messages: {
    messages: { x: 0, y: 0, width: 4, height: 3, isCollapsed: false },
    notifications: { x: 0, y: 3, width: 4, height: 2, isCollapsed: false },
...
// ═══════════════════════════════════════════════════════════════
// EXPORTED DEFAULT LAYOUTS (keyed by role, space-keyed)
// ═══════════════════════════════════════════════════════════════
