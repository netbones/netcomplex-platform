...
| `/api/admin/activity`                              | tenant-scoped         | PASS        | withTenant()         | Calls withTenant() and filters DB                       |
| `/api/admin/board-members`                         | tenant-scoped         | PASS        | withTenant()         | Calls withTenant(); no DB calls                         |
| `/api/admin/maintenance-stats`                     | tenant-scoped         | PASS        | withTenant()         | Calls withTenant(); no DB calls                         |
