...
| **Soft deletes** (`deletedAt`)         | Compliance audit complete — domain entities soft-delete, seats archive, join-table policy clarified. Missing DELETE endpoints: Booking, Conversation, Property, ServiceBooking. | ✅ Audit complete. 4 missing endpoints still needed                                                                                                                              |
