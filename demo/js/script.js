...
function initMap() {
    ...
    const streets = [
        { name: 'Pagoda Rd', coords: [-34.091650, 18.483269] },
        { name: 'Wild Almond Rd', coords: [-34.09025, 18.483569] },
        { name: 'Silkypuff Street', coords: [-34.09070, 18.483869] },
    ...
    streets.forEach(street => {
        L.marker(street.coords).addTo(map).bindTooltip(street.name, { permanent: true, direction: 'top', className: 'street-tooltip' }).on('click', () => {
    ...
    }).addTo(map).bindTooltip('Soralia Community Center', { direction: 'top', className: 'community-center-tooltip' });
}
